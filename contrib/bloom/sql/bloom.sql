...
INSERT INTO tst SELECT i%10, substr(md5(i::text), 1, 1) FROM generate_series(1,10) i;
...
INSERT INTO tstu SELECT i%10, substr(md5(i::text), 1, 1) FROM generate_series(1,10) i;
